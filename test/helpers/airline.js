 ...
 */
async function createAirline (wtIndex, airlineAccount) {
  await wtIndex.registerAirline('WT Airline', 'WT Test Airline', { from: airlineAccount });
  let wtAirlineAddress = await wtIndex.getAirlinesByManager(airlineAccount);
